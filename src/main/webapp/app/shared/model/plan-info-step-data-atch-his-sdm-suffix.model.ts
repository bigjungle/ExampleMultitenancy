...
export interface IPlanInfoStepDataAtchHisSdmSuffix {
    id?: number;
    name?: string;
    storeDir?: string;
    storeName?: string;
    ...
    planInfoStepDataHisName?: string;
    planInfoStepDataHisId?: number;
}

export class PlanInfoStepDataAtchHisSdmSuffix implements IPlanInfoStepDataAtchHisSdmSuffix {
    constructor(
        public id?: number,
        public name?: string,
        ...
        public planInfoStepDataHisName?: string,
        public planInfoStepDataHisId?: number
    ) {
