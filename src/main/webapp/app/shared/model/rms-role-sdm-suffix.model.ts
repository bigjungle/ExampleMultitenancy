...
export interface IRmsRoleSdmSuffix {
    id?: number;
    name?: string;
    serialNumber?: string;
    sortString?: string;
...
export class RmsRoleSdmSuffix implements IRmsRoleSdmSuffix {
    constructor(
        public id?: number,
        public name?: string,
        ...
        public rmsNodes?: IRmsNodeSdmSuffix[],
        public rmsUsers?: IRmsUserSdmSuffix[]
    ) {
