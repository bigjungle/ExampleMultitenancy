 ...
 * @author JungleYang
 */
@ApiModel(description = "PlanInfo 预案数据表 @author JungleYang")
@Entity
@Table(name = "plan_info_data")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "planinfodata")
public class PlanInfoData implements Serializable {
    ...
    public PlanInfoData name(String name) {
        this.name = name;
        return this;
    }
    ...
    public PlanInfoData sortString(String sortString) {
    ...
    public PlanInfoData descString(String descString) {
    ...
    public PlanInfoData jsonString(String jsonString) {
    ...
    public PlanInfoData remarks(String remarks) {
    ...
    public PlanInfoData refEvent(String refEvent) {
    ...
    public PlanInfoData attachmentPath(String attachmentPath) {
    ...
    public PlanInfoData attachmentBlob(byte[] attachmentBlob) {
    ...
    public PlanInfoData attachmentBlobContentType(String attachmentBlobContentType) {
    ...
    public PlanInfoData attachmentName(String attachmentName) {
    ...
    public PlanInfoData textBlob(String textBlob) {
    ...
    public PlanInfoData imageBlob(byte[] imageBlob) {
    ...
    public PlanInfoData imageBlobContentType(String imageBlobContentType) {
    ...
    public PlanInfoData imageBlobName(String imageBlobName) {
    ...
    public PlanInfoData usingFlag(Boolean usingFlag) {
    ...
    public PlanInfoData validType(ValidType validType) {
    ...
    public PlanInfoData validBegin(Instant validBegin) {
    ...
    public PlanInfoData validEnd(Instant validEnd) {
    ...
    public PlanInfoData insertTime(Instant insertTime) {
    ...
    public PlanInfoData updateTime(Instant updateTime) {
    ...
    public PlanInfoData verifyTime(Instant verifyTime) {
    ...
    public PlanInfoData verifyNeed(Boolean verifyNeed) {
    ...
    public PlanInfoData verifyOpinion(String verifyOpinion) {
    ...
    public PlanInfoData viewCount(Integer viewCount) {
    ...
    public PlanInfoData viewPermission(ViewPermission viewPermission) {
    ...
    public PlanInfoData viewPermPersion(String viewPermPersion) {
    ...
    public PlanInfoData serialNumber(String serialNumber) {
    ...
    public PlanInfoData versionNumber(String versionNumber) {
    ...
    public PlanInfoData paraSourceString(String paraSourceString) {
    ...
    public PlanInfoData featureKeyword(String featureKeyword) {
    ...
    public PlanInfoData suggestion(String suggestion) {
    ...
    public PlanInfoData releaseScope(String releaseScope) {
    ...
    public PlanInfoData currentStepOrder(Integer currentStepOrder) {
    ...
    public PlanInfoData verifyRec(VerifyRec verifyRec) {
    ...
    public PlanInfoData paraType(ParaType paraType) {
    ...
    public PlanInfoData paraClass(ParaClass paraClass) {
    ...
    public PlanInfoData paraCat(ParaCat paraCat) {
    ...
    public PlanInfoData paraState(ParaState paraState) {
    ...
    public PlanInfoData paraSource(ParaSource paraSource) {
    ...
    public PlanInfoData paraAttr(ParaAttr paraAttr) {
    ...
    public PlanInfoData paraProp(ParaProp paraProp) {
    ...
    public PlanInfoData createdBy(RmsUser rmsUser) {
    ...
    public PlanInfoData createdDepBy(RmsDep rmsDep) {
    ...
    public PlanInfoData ownerBy(RmsUser rmsUser) {
    ...
    public PlanInfoData ownerDepBy(RmsDep rmsDep) {
    ...
    public PlanInfoData modifiedBy(RmsUser rmsUser) {
    ...
    public PlanInfoData modifiedDepBy(RmsDep rmsDep) {
    ...
    public PlanInfoData verifiedBy(RmsUser rmsUser) {
    ...
    public PlanInfoData verifiedDepBy(RmsDep rmsDep) {
    ...
    public PlanInfoData publishedBy(RmsUser rmsUser) {
    ...
    public PlanInfoData publishedDepBy(RmsDep rmsDep) {
    ...
    public PlanInfoData getParent() {
        return parent;
    }

    public PlanInfoData parent(PlanInfoData planInfoData) {
        this.parent = planInfoData;
        return this;
    }

    public void setParent(PlanInfoData planInfoData) {
        this.parent = planInfoData;
    }
    ...
    public PlanInfoData planInfo(PlanInfo planInfo) {
    ...
    public boolean equals(Object o) {
        ...
        PlanInfoData planInfoData = (PlanInfoData) o;
        if (planInfoData.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), planInfoData.getId());
    }
