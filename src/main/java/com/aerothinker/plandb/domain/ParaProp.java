...
public class ParaProp implements Serializable {
    ...
    public ParaProp insertTime(Instant insertTime) {
    ...
    public ParaProp updateTime(Instant updateTime) {
    ...
    public ParaProp createdBy(RmsUser rmsUser) {
    ...
    public ParaProp modifiedBy(RmsUser rmsUser) {
    ...
    public ParaProp verifiedBy(RmsUser rmsUser) {
