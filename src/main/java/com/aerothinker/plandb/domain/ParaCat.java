 ...
 * @author JungleYang.
 */
@ApiModel(description = "Para Category  类别参数表 @author JungleYang.")
@Entity
@Table(name = "para_cat")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "paracat")
public class ParaCat implements Serializable {
    ...
    public ParaCat name(String name) {
        this.name = name;
        return this;
    }
    ...
    public ParaCat serialNumber(String serialNumber) {
    ...
    public ParaCat sortString(String sortString) {
    ...
    public ParaCat descString(String descString) {
    ...
    public ParaCat imageBlob(byte[] imageBlob) {
    ...
    public ParaCat imageBlobContentType(String imageBlobContentType) {
    ...
    public ParaCat imageBlobName(String imageBlobName) {
    ...
    public ParaCat usingFlag(Boolean usingFlag) {
    ...
    public ParaCat remarks(String remarks) {
    ...
    public ParaCat validType(ValidType validType) {
    ...
    public ParaCat validBegin(Instant validBegin) {
    ...
    public ParaCat validEnd(Instant validEnd) {
    ...
    public ParaCat insertTime(Instant insertTime) {
    ...
    public ParaCat updateTime(Instant updateTime) {
    ...
    public ParaCat verifyTime(Instant verifyTime) {
    ...
    public ParaCat createdBy(RmsUser rmsUser) {
    ...
    public ParaCat modifiedBy(RmsUser rmsUser) {
    ...
    public ParaCat verifiedBy(RmsUser rmsUser) {
    ...
    public ParaCat getParent() {
        return parent;
    }

    public ParaCat parent(ParaCat paraCat) {
        this.parent = paraCat;
        return this;
    }

    public void setParent(ParaCat paraCat) {
        this.parent = paraCat;
    }
    ...
    public boolean equals(Object o) {
        ...
        ParaCat paraCat = (ParaCat) o;
        if (paraCat.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), paraCat.getId());
    }
