...
/**
 * step attachment 预案步骤附件表
 * @author JungleYang
 */
@ApiModel(description = "step attachment 预案步骤附件表 @author JungleYang")
@Entity
@Table(name = "plan_info_step_atch")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "planinfostepatch")
public class PlanInfoStepAtch implements Serializable {
    ...
    public PlanInfoStepAtch name(String name) {
        this.name = name;
        return this;
    }
    ...
    public PlanInfoStepAtch storeDir(String storeDir) {
    ...
    public PlanInfoStepAtch storeName(String storeName) {
    ...
    public PlanInfoStepAtch sortString(String sortString) {
    ...
    public PlanInfoStepAtch fileType(String fileType) {
    ...
    public PlanInfoStepAtch deleteFlag(Boolean deleteFlag) {
    ...
    public PlanInfoStepAtch storeType(String storeType) {
    ...
    public PlanInfoStepAtch ver(String ver) {
        this.ver = ver;
        return this;
    }
    ...
    public PlanInfoStepAtch encryptedFlag(String encryptedFlag) {
    ...
    public PlanInfoStepAtch encryptedType(String encryptedType) {
    ...
    public PlanInfoStepAtch jsonString(String jsonString) {
    ...
    public PlanInfoStepAtch remarks(String remarks) {
    ...
    public PlanInfoStepAtch attachmentPath(String attachmentPath) {
    ...
    public PlanInfoStepAtch attachmentBlob(byte[] attachmentBlob) {
    ...
    public PlanInfoStepAtch attachmentBlobContentType(String attachmentBlobContentType) {
    ...
    public PlanInfoStepAtch attachmentName(String attachmentName) {
    ...
    public PlanInfoStepAtch textBlob(String textBlob) {
    ...
    public PlanInfoStepAtch imageBlob(byte[] imageBlob) {
    ...
    public PlanInfoStepAtch imageBlobContentType(String imageBlobContentType) {
    ...
    public PlanInfoStepAtch imageBlobName(String imageBlobName) {
    ...
    public PlanInfoStepAtch validType(ValidType validType) {
    ...
    public PlanInfoStepAtch validBegin(Instant validBegin) {
    ...
    public PlanInfoStepAtch validEnd(Instant validEnd) {
    ...
    public PlanInfoStepAtch insertTime(Instant insertTime) {
    ...
    public PlanInfoStepAtch updateTime(Instant updateTime) {
    ...
    public PlanInfoStepAtch createdBy(RmsUser rmsUser) {
    ...
    public PlanInfoStepAtch modifiedBy(RmsUser rmsUser) {
    ...
    public PlanInfoStepAtch planInfoStep(PlanInfoStep planInfoStep) {
    ...
    public boolean equals(Object o) {
        ...
        PlanInfoStepAtch planInfoStepAtch = (PlanInfoStepAtch) o;
        if (planInfoStepAtch.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), planInfoStepAtch.getId());
    }
