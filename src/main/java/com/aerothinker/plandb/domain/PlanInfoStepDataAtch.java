...
/**
 * step attachment 预案步骤数据附件表
 * @author JungleYang
 */
@ApiModel(description = "step attachment 预案步骤数据附件表 @author JungleYang")
@Entity
@Table(name = "plan_info_step_data_atch")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "planinfostepdataatch")
public class PlanInfoStepDataAtch implements Serializable {
    ...
    public PlanInfoStepDataAtch name(String name) {
        this.name = name;
        return this;
    }
    ...
    public PlanInfoStepDataAtch storeDir(String storeDir) {
    ...
    public PlanInfoStepDataAtch storeName(String storeName) {
    ...
    public PlanInfoStepDataAtch sortString(String sortString) {
    ...
    public PlanInfoStepDataAtch fileType(String fileType) {
    ...
    public PlanInfoStepDataAtch deleteFlag(Boolean deleteFlag) {
    ...
    public PlanInfoStepDataAtch storeType(String storeType) {
    ...
    public PlanInfoStepDataAtch ver(String ver) {
        this.ver = ver;
        return this;
    }
    ...
    public PlanInfoStepDataAtch encryptedFlag(String encryptedFlag) {
    ...
    public PlanInfoStepDataAtch encryptedType(String encryptedType) {
    ...
    public PlanInfoStepDataAtch jsonString(String jsonString) {
    ...
    public PlanInfoStepDataAtch remarks(String remarks) {
    ...
    public PlanInfoStepDataAtch attachmentPath(String attachmentPath) {
    ...
    public PlanInfoStepDataAtch attachmentBlob(byte[] attachmentBlob) {
    ...
    public PlanInfoStepDataAtch attachmentBlobContentType(String attachmentBlobContentType) {
    ...
    public PlanInfoStepDataAtch attachmentName(String attachmentName) {
    ...
    public PlanInfoStepDataAtch textBlob(String textBlob) {
    ...
    public PlanInfoStepDataAtch imageBlob(byte[] imageBlob) {
    ...
    public PlanInfoStepDataAtch imageBlobContentType(String imageBlobContentType) {
    ...
    public PlanInfoStepDataAtch imageBlobName(String imageBlobName) {
    ...
    public PlanInfoStepDataAtch validType(ValidType validType) {
    ...
    public PlanInfoStepDataAtch validBegin(Instant validBegin) {
    ...
    public PlanInfoStepDataAtch validEnd(Instant validEnd) {
    ...
    public PlanInfoStepDataAtch insertTime(Instant insertTime) {
    ...
    public PlanInfoStepDataAtch updateTime(Instant updateTime) {
    ...
    public PlanInfoStepDataAtch createdBy(RmsUser rmsUser) {
    ...
    public PlanInfoStepDataAtch modifiedBy(RmsUser rmsUser) {
    ...
    public PlanInfoStepDataAtch planInfoStepAtch(PlanInfoStepAtch planInfoStepAtch) {
    ...
    public PlanInfoStepData getPlanInfoStepData() {
        return planInfoStepData;
    }

    public PlanInfoStepDataAtch planInfoStepData(PlanInfoStepData planInfoStepData) {
        this.planInfoStepData = planInfoStepData;
        return this;
    }

    public void setPlanInfoStepData(PlanInfoStepData planInfoStepData) {
        this.planInfoStepData = planInfoStepData;
    }
    ...
    public boolean equals(Object o) {
        ...
        PlanInfoStepDataAtch planInfoStepDataAtch = (PlanInfoStepDataAtch) o;
        if (planInfoStepDataAtch.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), planInfoStepDataAtch.getId());
    }
