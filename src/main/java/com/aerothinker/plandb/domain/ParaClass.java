 ...
 * @author JungleYang.
 */
@ApiModel(description = "Para Classification  分类参数表 @author JungleYang.")
@Entity
@Table(name = "para_class")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "paraclass")
public class ParaClass implements Serializable {
    ...
    public ParaClass name(String name) {
        this.name = name;
        return this;
    }
    ...
    public ParaClass serialNumber(String serialNumber) {
    ...
    public ParaClass sortString(String sortString) {
    ...
    public ParaClass descString(String descString) {
    ...
    public ParaClass imageBlob(byte[] imageBlob) {
    ...
    public ParaClass imageBlobContentType(String imageBlobContentType) {
    ...
    public ParaClass imageBlobName(String imageBlobName) {
    ...
    public ParaClass usingFlag(Boolean usingFlag) {
    ...
    public ParaClass remarks(String remarks) {
    ...
    public ParaClass validType(ValidType validType) {
    ...
    public ParaClass validBegin(Instant validBegin) {
    ...
    public ParaClass validEnd(Instant validEnd) {
    ...
    public ParaClass insertTime(Instant insertTime) {
    ...
    public ParaClass updateTime(Instant updateTime) {
    ...
    public ParaClass verifyTime(Instant verifyTime) {
    ...
    public ParaClass createdBy(RmsUser rmsUser) {
    ...
    public ParaClass modifiedBy(RmsUser rmsUser) {
    ...
    public ParaClass verifiedBy(RmsUser rmsUser) {
    ...
    public ParaClass getParent() {
        return parent;
    }

    public ParaClass parent(ParaClass paraClass) {
        this.parent = paraClass;
        return this;
    }

    public void setParent(ParaClass paraClass) {
        this.parent = paraClass;
    }
    ...
    public boolean equals(Object o) {
        ...
        ParaClass paraClass = (ParaClass) o;
        if (paraClass.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), paraClass.getId());
    }
