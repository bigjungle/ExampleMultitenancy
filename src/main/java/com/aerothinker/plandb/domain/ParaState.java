...
public class ParaState implements Serializable {
    ...
    public ParaState insertTime(Instant insertTime) {
    ...
    public ParaState updateTime(Instant updateTime) {
    ...
    public ParaState createdBy(RmsUser rmsUser) {
    ...
    public ParaState modifiedBy(RmsUser rmsUser) {
    ...
    public ParaState verifiedBy(RmsUser rmsUser) {
