...
public class ParaAttr implements Serializable {
    ...
    public ParaAttr insertTime(Instant insertTime) {
    ...
    public ParaAttr updateTime(Instant updateTime) {
    ...
    public ParaAttr createdBy(RmsUser rmsUser) {
    ...
    public ParaAttr modifiedBy(RmsUser rmsUser) {
    ...
    public ParaAttr verifiedBy(RmsUser rmsUser) {
