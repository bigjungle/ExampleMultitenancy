...
/**
 * Criteria class for the PlanInfoStepDataAtch entity. This class is used in PlanInfoStepDataAtchResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /plan-info-step-data-atches?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PlanInfoStepDataAtchCriteria implements Serializable {
    /**
    ...
    private LongFilter planInfoStepDataId;
    ...
    public LongFilter getPlanInfoStepDataId() {
        return planInfoStepDataId;
    }

    public void setPlanInfoStepDataId(LongFilter planInfoStepDataId) {
    ...
    public boolean equals(Object o) {
        ...
        final PlanInfoStepDataAtchCriteria that = (PlanInfoStepDataAtchCriteria) o;
        return
            ...
            Objects.equals(planInfoStepDataId, that.planInfoStepDataId);
    }
    ...
    public String toString() {
        return "PlanInfoStepDataAtchCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
                ...
                (planInfoStepDataId != null ? "planInfoStepDataId=" + planInfoStepDataId + ", " : "") +
            "}";
    }
