...
/**
 * A DTO for the ParaProp entity.
 */
public class ParaPropDTO implements Serializable {
    ...
    public void setParentId(Long paraPropId) {
        this.parentId = paraPropId;
    }
    ...
    public void setParentName(String paraPropName) {
        this.parentName = paraPropName;
    }
    ...
    public boolean equals(Object o) {
        ...
        ParaPropDTO paraPropDTO = (ParaPropDTO) o;
        if (paraPropDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), paraPropDTO.getId());
    }
