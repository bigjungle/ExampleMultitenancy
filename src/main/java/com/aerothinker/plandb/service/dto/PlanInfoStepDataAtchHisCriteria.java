...
/**
 * Criteria class for the PlanInfoStepDataAtchHis entity. This class is used in PlanInfoStepDataAtchHisResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /plan-info-step-data-atch-his?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PlanInfoStepDataAtchHisCriteria implements Serializable {
    /**
    ...
    private LongFilter planInfoStepAtchId;

    private LongFilter planInfoStepDataHisId;
    ...
    public LongFilter getPlanInfoStepAtchId() {
        return planInfoStepAtchId;
    }

    public void setPlanInfoStepAtchId(LongFilter planInfoStepAtchId) {
        this.planInfoStepAtchId = planInfoStepAtchId;
    }

    public LongFilter getPlanInfoStepDataHisId() {
        return planInfoStepDataHisId;
    }

    public void setPlanInfoStepDataHisId(LongFilter planInfoStepDataHisId) {
        this.planInfoStepDataHisId = planInfoStepDataHisId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final PlanInfoStepDataAtchHisCriteria that = (PlanInfoStepDataAtchHisCriteria) o;
        return
            ...
            Objects.equals(planInfoStepAtchId, that.planInfoStepAtchId) &&
            Objects.equals(planInfoStepDataHisId, that.planInfoStepDataHisId);
    }
    ...
    public int hashCode() {
        ...
        modifiedById,
        planInfoStepAtchId,
        planInfoStepDataHisId
        );
    }

    @Override
    public String toString() {
        return "PlanInfoStepDataAtchHisCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
                ...
                (planInfoStepAtchId != null ? "planInfoStepAtchId=" + planInfoStepAtchId + ", " : "") +
                (planInfoStepDataHisId != null ? "planInfoStepDataHisId=" + planInfoStepDataHisId + ", " : "") +
            "}";
    }
