...
/**
 * A DTO for the ParaState entity.
 */
public class ParaStateDTO implements Serializable {
    ...
    public void setParentId(Long paraStateId) {
        this.parentId = paraStateId;
    }
    ...
    public void setParentName(String paraStateName) {
        this.parentName = paraStateName;
    }
    ...
    public boolean equals(Object o) {
        ...
        ParaStateDTO paraStateDTO = (ParaStateDTO) o;
        if (paraStateDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), paraStateDTO.getId());
    }
