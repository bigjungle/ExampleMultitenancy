...
/**
 * A DTO for the PlanInfoStepAtch entity.
 */
public class PlanInfoStepAtchDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        PlanInfoStepAtchDTO planInfoStepAtchDTO = (PlanInfoStepAtchDTO) o;
        if (planInfoStepAtchDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), planInfoStepAtchDTO.getId());
    }
