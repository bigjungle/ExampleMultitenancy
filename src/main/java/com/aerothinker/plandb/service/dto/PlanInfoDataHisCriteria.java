...
/**
 * Criteria class for the PlanInfoDataHis entity. This class is used in PlanInfoDataHisResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /plan-info-data-his?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class PlanInfoDataHisCriteria implements Serializable {
    /**
    ...
    private IntegerFilter currentStepOrder;
    ...
    public IntegerFilter getCurrentStepOrder() {
        return currentStepOrder;
    }

    public void setCurrentStepOrder(IntegerFilter currentStepOrder) {
    ...
    public boolean equals(Object o) {
        ...
        final PlanInfoDataHisCriteria that = (PlanInfoDataHisCriteria) o;
        return
            ...
            Objects.equals(currentStepOrder, that.currentStepOrder) &&
    ...
    public String toString() {
        return "PlanInfoDataHisCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
                ...
                (currentStepOrder != null ? "currentStepOrder=" + currentStepOrder + ", " : "") +
