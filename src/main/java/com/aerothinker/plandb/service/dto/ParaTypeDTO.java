...
/**
 * A DTO for the ParaType entity.
 */
public class ParaTypeDTO implements Serializable {
    ...
    public void setParentId(Long paraTypeId) {
        this.parentId = paraTypeId;
    }
    ...
    public void setParentName(String paraTypeName) {
        this.parentName = paraTypeName;
    }
    ...
    public boolean equals(Object o) {
        ...
        ParaTypeDTO paraTypeDTO = (ParaTypeDTO) o;
        if (paraTypeDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), paraTypeDTO.getId());
    }
