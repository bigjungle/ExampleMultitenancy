...
/**
 * A DTO for the PlanInfoDataHis entity.
 */
public class PlanInfoDataHisDTO implements Serializable {
    ...
    public void setParentId(Long planInfoDataHisId) {
        this.parentId = planInfoDataHisId;
    }
    ...
    public void setParentName(String planInfoDataHisName) {
        this.parentName = planInfoDataHisName;
    }
    ...
    public boolean equals(Object o) {
        ...
        PlanInfoDataHisDTO planInfoDataHisDTO = (PlanInfoDataHisDTO) o;
        if (planInfoDataHisDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), planInfoDataHisDTO.getId());
    }
