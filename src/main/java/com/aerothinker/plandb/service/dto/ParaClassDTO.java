...
/**
 * A DTO for the ParaClass entity.
 */
public class ParaClassDTO implements Serializable {
    ...
    public void setParentId(Long paraClassId) {
        this.parentId = paraClassId;
    }
    ...
    public void setParentName(String paraClassName) {
        this.parentName = paraClassName;
    }
    ...
    public boolean equals(Object o) {
        ...
        ParaClassDTO paraClassDTO = (ParaClassDTO) o;
        if (paraClassDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), paraClassDTO.getId());
    }
