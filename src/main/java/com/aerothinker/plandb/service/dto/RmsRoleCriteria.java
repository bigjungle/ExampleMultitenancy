...
/**
 * Criteria class for the RmsRole entity. This class is used in RmsRoleResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /rms-roles?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class RmsRoleCriteria implements Serializable {
    /**
    ...
    private LongFilter rmsNodeId;

    private LongFilter rmsUserId;
    ...
    public LongFilter getRmsNodeId() {
        return rmsNodeId;
    }

    public void setRmsNodeId(LongFilter rmsNodeId) {
        this.rmsNodeId = rmsNodeId;
    }

    public LongFilter getRmsUserId() {
        return rmsUserId;
    }

    public void setRmsUserId(LongFilter rmsUserId) {
    ...
    public boolean equals(Object o) {
        ...
        final RmsRoleCriteria that = (RmsRoleCriteria) o;
        return
            ...
            Objects.equals(rmsNodeId, that.rmsNodeId) &&
            Objects.equals(rmsUserId, that.rmsUserId);
    }
    ...
    public String toString() {
        return "RmsRoleCriteria{" +
                ...
                (rmsNodeId != null ? "rmsNodeId=" + rmsNodeId + ", " : "") +
                (rmsUserId != null ? "rmsUserId=" + rmsUserId + ", " : "") +
            "}";
    }
