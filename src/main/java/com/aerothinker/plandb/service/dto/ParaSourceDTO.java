...
/**
 * A DTO for the ParaSource entity.
 */
public class ParaSourceDTO implements Serializable {
    ...
    public void setParentId(Long paraSourceId) {
        this.parentId = paraSourceId;
    }
    ...
    public void setParentName(String paraSourceName) {
        this.parentName = paraSourceName;
    }
    ...
    public boolean equals(Object o) {
        ...
        ParaSourceDTO paraSourceDTO = (ParaSourceDTO) o;
        if (paraSourceDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), paraSourceDTO.getId());
    }
