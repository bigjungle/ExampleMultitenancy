 ...
 */
public class ParaAttrDTO implements Serializable {
    ...
    public void setParentId(Long paraAttrId) {
        this.parentId = paraAttrId;
    }
    ...
    public void setParentName(String paraAttrName) {
        this.parentName = paraAttrName;
    }
