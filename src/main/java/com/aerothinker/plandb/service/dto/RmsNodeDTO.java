...
/**
 * A DTO for the RmsNode entity.
 */
public class RmsNodeDTO implements Serializable {
    ...
    public void setParentId(Long rmsNodeId) {
        this.parentId = rmsNodeId;
    }
    ...
    public void setParentName(String rmsNodeName) {
        this.parentName = rmsNodeName;
    }
    ...
    public boolean equals(Object o) {
        ...
        RmsNodeDTO rmsNodeDTO = (RmsNodeDTO) o;
        if (rmsNodeDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), rmsNodeDTO.getId());
    }
