...
/**
 * Mapper for the entity PlanInfo and its DTO PlanInfoDTO.
 */
@Mapper(componentModel = "spring", uses = {VerifyRecMapper.class, ParaTypeMapper.class, ParaClassMapper.class, ParaCatMapper.class, ParaStateMapper.class, ParaSourceMapper.class, ParaAttrMapper.class, ParaPropMapper.class, RmsUserMapper.class, RmsDepMapper.class, CompanyMapper.class})
public interface PlanInfoMapper extends EntityMapper<PlanInfoDTO, PlanInfo> {
    ...
    PlanInfoDTO toDto(PlanInfo planInfo);
