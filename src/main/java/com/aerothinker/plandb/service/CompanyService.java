...
import com.aerothinker.plandb.repository.CompanyRepository;
import com.aerothinker.plandb.repository.search.CompanySearchRepository;
...
public class CompanyService {
    ...
    /** 
    * Get one company by id including the users.
    * 
    * @param id the id of the entity
    * @return the entity
    */
    @Transactional(readOnly = true)
    public Optional<Company> findOneAndFetchUsersEagerly(Long id) {
        log.debug("Request to get Company with users: {}", id);
        return companyRepository.findOneAndFetchUsersEagerly(id);
    }
