...
import com.aerothinker.plandb.service.dto.UserDTO;
...
private final Logger log = LoggerFactory.getLogger(UserAspect.class);
     ...
     */
    @Before(value = "execution(* com.aerothinker.plandb.service.UserService.createUser(..)) && args(userDTO, ..)")
     ...
     */
    @Before(value = "execution(*  com.aerothinker.plandb.service.UserService.updateUser(..)) && args(userDTO, ..)")
     ...
     * Adds tenant information to DTO.
     */
    @Before(value = "execution(* com.aerothinker.plandb.repository.UserRepository.save(..)) && args(user, ..)")
     ...
     */
    @Before(value = "execution(* com.aerothinker.plandb.service.UserService.getUserWithAuthoritiesByLogin(..)) && args(login, ..)")
     ...
     * Adds filtering to prevent display of information from another tenant
     */
    @Before(value = "execution(* com.aerothinker.plandb.service.UserService.getUserWithAuthorities(..)) && args(id, ..)")
