...
import com.aerothinker.plandb.service.ParaStateService;
...
import com.aerothinker.plandb.service.ParaStateQueryService;
...
public class ParaStateResourceIntTest {
     ...
     *
     * @see com.aerothinker.plandb.repository.search.ParaStateSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createParaState() throws Exception {
        ...
        assertThat(testParaState.getInsertTime()).isEqualTo(DEFAULT_INSERT_TIME);
        assertThat(testParaState.getUpdateTime()).isEqualTo(DEFAULT_UPDATE_TIME);
    ...
    @Test
    @Transactional
    public void getAllParaStatesByInsertTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        paraStateRepository.saveAndFlush(paraState);

        // Get all the paraStateList where insertTime equals to DEFAULT_INSERT_TIME
        defaultParaStateShouldBeFound("insertTime.equals=" + DEFAULT_INSERT_TIME);

        // Get all the paraStateList where insertTime equals to UPDATED_INSERT_TIME
        defaultParaStateShouldNotBeFound("insertTime.equals=" + UPDATED_INSERT_TIME);
    }

    @Test
    @Transactional
    public void getAllParaStatesByInsertTimeIsInShouldWork() throws Exception {
        // Initialize the database
        paraStateRepository.saveAndFlush(paraState);

        // Get all the paraStateList where insertTime in DEFAULT_INSERT_TIME or UPDATED_INSERT_TIME
        defaultParaStateShouldBeFound("insertTime.in=" + DEFAULT_INSERT_TIME + "," + UPDATED_INSERT_TIME);

        // Get all the paraStateList where insertTime equals to UPDATED_INSERT_TIME
        defaultParaStateShouldNotBeFound("insertTime.in=" + UPDATED_INSERT_TIME);
    }

    @Test
    @Transactional
    public void getAllParaStatesByInsertTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        paraStateRepository.saveAndFlush(paraState);

        // Get all the paraStateList where insertTime is not null
        defaultParaStateShouldBeFound("insertTime.specified=true");

        // Get all the paraStateList where insertTime is null
        defaultParaStateShouldNotBeFound("insertTime.specified=false");
    }

    @Test
    @Transactional
    public void getAllParaStatesByUpdateTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        paraStateRepository.saveAndFlush(paraState);

        // Get all the paraStateList where updateTime equals to DEFAULT_UPDATE_TIME
        defaultParaStateShouldBeFound("updateTime.equals=" + DEFAULT_UPDATE_TIME);

        // Get all the paraStateList where updateTime equals to UPDATED_UPDATE_TIME
        defaultParaStateShouldNotBeFound("updateTime.equals=" + UPDATED_UPDATE_TIME);
    }

    @Test
    @Transactional
    public void getAllParaStatesByUpdateTimeIsInShouldWork() throws Exception {
        // Initialize the database
        paraStateRepository.saveAndFlush(paraState);

        // Get all the paraStateList where updateTime in DEFAULT_UPDATE_TIME or UPDATED_UPDATE_TIME
        defaultParaStateShouldBeFound("updateTime.in=" + DEFAULT_UPDATE_TIME + "," + UPDATED_UPDATE_TIME);

        // Get all the paraStateList where updateTime equals to UPDATED_UPDATE_TIME
        defaultParaStateShouldNotBeFound("updateTime.in=" + UPDATED_UPDATE_TIME);
    }

    @Test
    @Transactional
    public void getAllParaStatesByUpdateTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        paraStateRepository.saveAndFlush(paraState);

        // Get all the paraStateList where updateTime is not null
        defaultParaStateShouldBeFound("updateTime.specified=true");

        // Get all the paraStateList where updateTime is null
        defaultParaStateShouldNotBeFound("updateTime.specified=false");
    }
    ...
    @Test
    @Transactional
    public void getAllParaStatesByCreatedByIsEqualToSomething() throws Exception {
        // Initialize the database
        RmsUser createdBy = RmsUserResourceIntTest.createEntity(em);
        em.persist(createdBy);
        em.flush();
        paraState.setCreatedBy(createdBy);
        paraStateRepository.saveAndFlush(paraState);
        Long createdById = createdBy.getId();

        // Get all the paraStateList where createdBy equals to createdById
        defaultParaStateShouldBeFound("createdById.equals=" + createdById);

        // Get all the paraStateList where createdBy equals to createdById + 1
        defaultParaStateShouldNotBeFound("createdById.equals=" + (createdById + 1));
    }


    @Test
    @Transactional
    public void getAllParaStatesByModifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        RmsUser modifiedBy = RmsUserResourceIntTest.createEntity(em);
        em.persist(modifiedBy);
        em.flush();
        paraState.setModifiedBy(modifiedBy);
        paraStateRepository.saveAndFlush(paraState);
        Long modifiedById = modifiedBy.getId();

        // Get all the paraStateList where modifiedBy equals to modifiedById
        defaultParaStateShouldBeFound("modifiedById.equals=" + modifiedById);

        // Get all the paraStateList where modifiedBy equals to modifiedById + 1
        defaultParaStateShouldNotBeFound("modifiedById.equals=" + (modifiedById + 1));
    }


    @Test
    @Transactional
    public void getAllParaStatesByVerifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        RmsUser verifiedBy = RmsUserResourceIntTest.createEntity(em);
        em.persist(verifiedBy);
        em.flush();
        paraState.setVerifiedBy(verifiedBy);
        paraStateRepository.saveAndFlush(paraState);
        Long verifiedById = verifiedBy.getId();

        // Get all the paraStateList where verifiedBy equals to verifiedById
        defaultParaStateShouldBeFound("verifiedById.equals=" + verifiedById);

        // Get all the paraStateList where verifiedBy equals to verifiedById + 1
        defaultParaStateShouldNotBeFound("verifiedById.equals=" + (verifiedById + 1));
    }
    ...
    public void updateParaState() throws Exception {
        ...
        assertThat(testParaState.getInsertTime()).isEqualTo(UPDATED_INSERT_TIME);
        assertThat(testParaState.getUpdateTime()).isEqualTo(UPDATED_UPDATE_TIME);
