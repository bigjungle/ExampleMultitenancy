...
import com.aerothinker.plandb.service.ParaPropService;
...
import com.aerothinker.plandb.service.ParaPropQueryService;
...
public class ParaPropResourceIntTest {
     ...
     *
     * @see com.aerothinker.plandb.repository.search.ParaPropSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createParaProp() throws Exception {
        ...
        assertThat(testParaProp.getInsertTime()).isEqualTo(DEFAULT_INSERT_TIME);
        assertThat(testParaProp.getUpdateTime()).isEqualTo(DEFAULT_UPDATE_TIME);
    ...
    @Test
    @Transactional
    public void getAllParaPropsByInsertTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        paraPropRepository.saveAndFlush(paraProp);

        // Get all the paraPropList where insertTime equals to DEFAULT_INSERT_TIME
        defaultParaPropShouldBeFound("insertTime.equals=" + DEFAULT_INSERT_TIME);

        // Get all the paraPropList where insertTime equals to UPDATED_INSERT_TIME
        defaultParaPropShouldNotBeFound("insertTime.equals=" + UPDATED_INSERT_TIME);
    }

    @Test
    @Transactional
    public void getAllParaPropsByInsertTimeIsInShouldWork() throws Exception {
        // Initialize the database
        paraPropRepository.saveAndFlush(paraProp);

        // Get all the paraPropList where insertTime in DEFAULT_INSERT_TIME or UPDATED_INSERT_TIME
        defaultParaPropShouldBeFound("insertTime.in=" + DEFAULT_INSERT_TIME + "," + UPDATED_INSERT_TIME);

        // Get all the paraPropList where insertTime equals to UPDATED_INSERT_TIME
        defaultParaPropShouldNotBeFound("insertTime.in=" + UPDATED_INSERT_TIME);
    }

    @Test
    @Transactional
    public void getAllParaPropsByInsertTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        paraPropRepository.saveAndFlush(paraProp);

        // Get all the paraPropList where insertTime is not null
        defaultParaPropShouldBeFound("insertTime.specified=true");

        // Get all the paraPropList where insertTime is null
        defaultParaPropShouldNotBeFound("insertTime.specified=false");
    }

    @Test
    @Transactional
    public void getAllParaPropsByUpdateTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        paraPropRepository.saveAndFlush(paraProp);

        // Get all the paraPropList where updateTime equals to DEFAULT_UPDATE_TIME
        defaultParaPropShouldBeFound("updateTime.equals=" + DEFAULT_UPDATE_TIME);

        // Get all the paraPropList where updateTime equals to UPDATED_UPDATE_TIME
        defaultParaPropShouldNotBeFound("updateTime.equals=" + UPDATED_UPDATE_TIME);
    }

    @Test
    @Transactional
    public void getAllParaPropsByUpdateTimeIsInShouldWork() throws Exception {
        // Initialize the database
        paraPropRepository.saveAndFlush(paraProp);

        // Get all the paraPropList where updateTime in DEFAULT_UPDATE_TIME or UPDATED_UPDATE_TIME
        defaultParaPropShouldBeFound("updateTime.in=" + DEFAULT_UPDATE_TIME + "," + UPDATED_UPDATE_TIME);

        // Get all the paraPropList where updateTime equals to UPDATED_UPDATE_TIME
        defaultParaPropShouldNotBeFound("updateTime.in=" + UPDATED_UPDATE_TIME);
    }

    @Test
    @Transactional
    public void getAllParaPropsByUpdateTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        paraPropRepository.saveAndFlush(paraProp);

        // Get all the paraPropList where updateTime is not null
        defaultParaPropShouldBeFound("updateTime.specified=true");

        // Get all the paraPropList where updateTime is null
        defaultParaPropShouldNotBeFound("updateTime.specified=false");
    }
    ...
    @Test
    @Transactional
    public void getAllParaPropsByCreatedByIsEqualToSomething() throws Exception {
        // Initialize the database
        RmsUser createdBy = RmsUserResourceIntTest.createEntity(em);
        em.persist(createdBy);
        em.flush();
        paraProp.setCreatedBy(createdBy);
        paraPropRepository.saveAndFlush(paraProp);
        Long createdById = createdBy.getId();

        // Get all the paraPropList where createdBy equals to createdById
        defaultParaPropShouldBeFound("createdById.equals=" + createdById);

        // Get all the paraPropList where createdBy equals to createdById + 1
        defaultParaPropShouldNotBeFound("createdById.equals=" + (createdById + 1));
    }


    @Test
    @Transactional
    public void getAllParaPropsByModifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        RmsUser modifiedBy = RmsUserResourceIntTest.createEntity(em);
        em.persist(modifiedBy);
        em.flush();
        paraProp.setModifiedBy(modifiedBy);
        paraPropRepository.saveAndFlush(paraProp);
        Long modifiedById = modifiedBy.getId();

        // Get all the paraPropList where modifiedBy equals to modifiedById
        defaultParaPropShouldBeFound("modifiedById.equals=" + modifiedById);

        // Get all the paraPropList where modifiedBy equals to modifiedById + 1
        defaultParaPropShouldNotBeFound("modifiedById.equals=" + (modifiedById + 1));
    }


    @Test
    @Transactional
    public void getAllParaPropsByVerifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        RmsUser verifiedBy = RmsUserResourceIntTest.createEntity(em);
        em.persist(verifiedBy);
        em.flush();
        paraProp.setVerifiedBy(verifiedBy);
        paraPropRepository.saveAndFlush(paraProp);
        Long verifiedById = verifiedBy.getId();

        // Get all the paraPropList where verifiedBy equals to verifiedById
        defaultParaPropShouldBeFound("verifiedById.equals=" + verifiedById);

        // Get all the paraPropList where verifiedBy equals to verifiedById + 1
        defaultParaPropShouldNotBeFound("verifiedById.equals=" + (verifiedById + 1));
    }
    ...
    public void updateParaProp() throws Exception {
        ...
        assertThat(testParaProp.getInsertTime()).isEqualTo(UPDATED_INSERT_TIME);
        assertThat(testParaProp.getUpdateTime()).isEqualTo(UPDATED_UPDATE_TIME);
