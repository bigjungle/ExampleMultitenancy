...
import com.aerothinker.plandb.service.ParaClassService;
...
import com.aerothinker.plandb.service.ParaClassQueryService;
...
public class ParaClassResourceIntTest {
     ...
     *
     * @see com.aerothinker.plandb.repository.search.ParaClassSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createParaClass() throws Exception {
        ...
        assertThat(testParaClass.getInsertTime()).isEqualTo(DEFAULT_INSERT_TIME);
        assertThat(testParaClass.getUpdateTime()).isEqualTo(DEFAULT_UPDATE_TIME);
    ...
    @Test
    @Transactional
    public void getAllParaClassesByInsertTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        paraClassRepository.saveAndFlush(paraClass);

        // Get all the paraClassList where insertTime equals to DEFAULT_INSERT_TIME
        defaultParaClassShouldBeFound("insertTime.equals=" + DEFAULT_INSERT_TIME);

        // Get all the paraClassList where insertTime equals to UPDATED_INSERT_TIME
        defaultParaClassShouldNotBeFound("insertTime.equals=" + UPDATED_INSERT_TIME);
    }

    @Test
    @Transactional
    public void getAllParaClassesByInsertTimeIsInShouldWork() throws Exception {
        // Initialize the database
        paraClassRepository.saveAndFlush(paraClass);

        // Get all the paraClassList where insertTime in DEFAULT_INSERT_TIME or UPDATED_INSERT_TIME
        defaultParaClassShouldBeFound("insertTime.in=" + DEFAULT_INSERT_TIME + "," + UPDATED_INSERT_TIME);

        // Get all the paraClassList where insertTime equals to UPDATED_INSERT_TIME
        defaultParaClassShouldNotBeFound("insertTime.in=" + UPDATED_INSERT_TIME);
    }

    @Test
    @Transactional
    public void getAllParaClassesByInsertTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        paraClassRepository.saveAndFlush(paraClass);

        // Get all the paraClassList where insertTime is not null
        defaultParaClassShouldBeFound("insertTime.specified=true");

        // Get all the paraClassList where insertTime is null
        defaultParaClassShouldNotBeFound("insertTime.specified=false");
    }

    @Test
    @Transactional
    public void getAllParaClassesByUpdateTimeIsEqualToSomething() throws Exception {
        // Initialize the database
        paraClassRepository.saveAndFlush(paraClass);

        // Get all the paraClassList where updateTime equals to DEFAULT_UPDATE_TIME
        defaultParaClassShouldBeFound("updateTime.equals=" + DEFAULT_UPDATE_TIME);

        // Get all the paraClassList where updateTime equals to UPDATED_UPDATE_TIME
        defaultParaClassShouldNotBeFound("updateTime.equals=" + UPDATED_UPDATE_TIME);
    }

    @Test
    @Transactional
    public void getAllParaClassesByUpdateTimeIsInShouldWork() throws Exception {
        // Initialize the database
        paraClassRepository.saveAndFlush(paraClass);

        // Get all the paraClassList where updateTime in DEFAULT_UPDATE_TIME or UPDATED_UPDATE_TIME
        defaultParaClassShouldBeFound("updateTime.in=" + DEFAULT_UPDATE_TIME + "," + UPDATED_UPDATE_TIME);

        // Get all the paraClassList where updateTime equals to UPDATED_UPDATE_TIME
        defaultParaClassShouldNotBeFound("updateTime.in=" + UPDATED_UPDATE_TIME);
    }

    @Test
    @Transactional
    public void getAllParaClassesByUpdateTimeIsNullOrNotNull() throws Exception {
        // Initialize the database
        paraClassRepository.saveAndFlush(paraClass);

        // Get all the paraClassList where updateTime is not null
        defaultParaClassShouldBeFound("updateTime.specified=true");

        // Get all the paraClassList where updateTime is null
        defaultParaClassShouldNotBeFound("updateTime.specified=false");
    }
    ...
    @Test
    @Transactional
    public void getAllParaClassesByCreatedByIsEqualToSomething() throws Exception {
        // Initialize the database
        RmsUser createdBy = RmsUserResourceIntTest.createEntity(em);
        em.persist(createdBy);
        em.flush();
        paraClass.setCreatedBy(createdBy);
        paraClassRepository.saveAndFlush(paraClass);
        Long createdById = createdBy.getId();

        // Get all the paraClassList where createdBy equals to createdById
        defaultParaClassShouldBeFound("createdById.equals=" + createdById);

        // Get all the paraClassList where createdBy equals to createdById + 1
        defaultParaClassShouldNotBeFound("createdById.equals=" + (createdById + 1));
    }


    @Test
    @Transactional
    public void getAllParaClassesByModifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        RmsUser modifiedBy = RmsUserResourceIntTest.createEntity(em);
        em.persist(modifiedBy);
        em.flush();
        paraClass.setModifiedBy(modifiedBy);
        paraClassRepository.saveAndFlush(paraClass);
        Long modifiedById = modifiedBy.getId();

        // Get all the paraClassList where modifiedBy equals to modifiedById
        defaultParaClassShouldBeFound("modifiedById.equals=" + modifiedById);

        // Get all the paraClassList where modifiedBy equals to modifiedById + 1
        defaultParaClassShouldNotBeFound("modifiedById.equals=" + (modifiedById + 1));
    }


    @Test
    @Transactional
    public void getAllParaClassesByVerifiedByIsEqualToSomething() throws Exception {
        // Initialize the database
        RmsUser verifiedBy = RmsUserResourceIntTest.createEntity(em);
        em.persist(verifiedBy);
        em.flush();
        paraClass.setVerifiedBy(verifiedBy);
        paraClassRepository.saveAndFlush(paraClass);
        Long verifiedById = verifiedBy.getId();

        // Get all the paraClassList where verifiedBy equals to verifiedById
        defaultParaClassShouldBeFound("verifiedById.equals=" + verifiedById);

        // Get all the paraClassList where verifiedBy equals to verifiedById + 1
        defaultParaClassShouldNotBeFound("verifiedById.equals=" + (verifiedById + 1));
    }
    ...
    public void updateParaClass() throws Exception {
        ...
        assertThat(testParaClass.getInsertTime()).isEqualTo(UPDATED_INSERT_TIME);
        assertThat(testParaClass.getUpdateTime()).isEqualTo(UPDATED_UPDATE_TIME);
