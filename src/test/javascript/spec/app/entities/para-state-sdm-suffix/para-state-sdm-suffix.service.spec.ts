...
import { IParaStateSdmSuffix, ParaStateSdmSuffix, ValidType } from 'app/shared/model/para-state-sdm-suffix.model';

describe('Service Tests', () => {
    describe('ParaStateSdmSuffix Service', () => {
        let injector: TestBed;
        let service: ParaStateSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IParaStateSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ParaStateSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new ParaStateSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ParaStateSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new ParaStateSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a ParaStateSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should return a list of ParaStateSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should delete a ParaStateSdmSuffix', async () => {
