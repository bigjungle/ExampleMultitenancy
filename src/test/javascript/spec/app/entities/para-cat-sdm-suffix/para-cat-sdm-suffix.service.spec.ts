...
import { IParaCatSdmSuffix, ParaCatSdmSuffix, ValidType } from 'app/shared/model/para-cat-sdm-suffix.model';

describe('Service Tests', () => {
    describe('ParaCatSdmSuffix Service', () => {
        let injector: TestBed;
        let service: ParaCatSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IParaCatSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ParaCatSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new ParaCatSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ParaCatSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new ParaCatSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a ParaCatSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should return a list of ParaCatSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should delete a ParaCatSdmSuffix', async () => {
