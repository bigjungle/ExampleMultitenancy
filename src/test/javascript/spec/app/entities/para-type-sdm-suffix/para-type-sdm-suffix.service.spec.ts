...
import { IParaTypeSdmSuffix, ParaTypeSdmSuffix, ValidType } from 'app/shared/model/para-type-sdm-suffix.model';

describe('Service Tests', () => {
    describe('ParaTypeSdmSuffix Service', () => {
        let injector: TestBed;
        let service: ParaTypeSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IParaTypeSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ParaTypeSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new ParaTypeSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ParaTypeSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new ParaTypeSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a ParaTypeSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should return a list of ParaTypeSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should delete a ParaTypeSdmSuffix', async () => {
