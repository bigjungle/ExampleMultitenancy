...
import { IParaPropSdmSuffix, ParaPropSdmSuffix, ValidType } from 'app/shared/model/para-prop-sdm-suffix.model';

describe('Service Tests', () => {
    describe('ParaPropSdmSuffix Service', () => {
        let injector: TestBed;
        let service: ParaPropSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IParaPropSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ParaPropSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new ParaPropSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ParaPropSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new ParaPropSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a ParaPropSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should return a list of ParaPropSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should delete a ParaPropSdmSuffix', async () => {
