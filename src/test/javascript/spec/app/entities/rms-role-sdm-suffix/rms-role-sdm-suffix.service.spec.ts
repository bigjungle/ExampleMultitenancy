...
import { IRmsRoleSdmSuffix, RmsRoleSdmSuffix, ValidType } from 'app/shared/model/rms-role-sdm-suffix.model';

describe('Service Tests', () => {
    describe('RmsRoleSdmSuffix Service', () => {
        let injector: TestBed;
        let service: RmsRoleSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IRmsRoleSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RmsRoleSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new RmsRoleSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a RmsRoleSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new RmsRoleSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a RmsRoleSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should return a list of RmsRoleSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        serialNumber: 'BBBBBB',
            ...
            it('should delete a RmsRoleSdmSuffix', async () => {
